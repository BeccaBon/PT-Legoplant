...
if (character == "P" && !ispeppino && !skateboarding && ((key_up2 && key_jump2)) && state != states.mach3 && can_jump && vsp > 0 && (state == states.normal || state == states.mach2))
{
...
{
	toomuchalarm1 -= 1
	if (toomuchalarm1 <= 0 && (state == states.mach3 or state == states.mach2))
	{
		with (create_mach3effect(x, y, sprite_index, (image_index - 1)))
		{
			playerid = other.object_index
