function scr_player_knightpep()
{
	...
	else if (sprite_index == spr_knightpep_attack or sprite_index == spr_knightpepjump or sprite_index == spr_knightpepfall or sprite_index == spr_knightpepdoublejump or sprite_index == spr_knightpepdowntrust)
	{
