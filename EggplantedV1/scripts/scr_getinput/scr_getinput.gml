function scr_getinput()
{
	...
	key_groundpound = (keyboard_check(global.key_groundpound) or gamepad_button_check(_dvc, global.key_groundpoundC) or gamepad_button_check(_dvc, gp_shoulderrb))
	key_groundpound2 = (keyboard_check_pressed(global.key_groundpound) or gamepad_button_check_pressed(_dvc, global.key_groundpoundC) or gamepad_button_check_pressed(_dvc, gp_shoulderrb))
...
{
	var gp = global.keyboard_groundpound;
	if obj_inputAssigner.player_input_device[obj_inputAssigner.player_index] < 0
